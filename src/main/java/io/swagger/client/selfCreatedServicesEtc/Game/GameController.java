...
public class GameController {
    public static String turn(DefaultApi api, String gameId, String mapId, String robotID, String playerId, LocalRobot robotTurn, LocalRobot robotNotTurn)
            throws ApiException {
        ...
        return MoveServices.endMove(api, gameId, playerId, robotTurn);
    }

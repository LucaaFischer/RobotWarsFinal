...
public class DefaultApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Robot apiRobotsRobotIdGet(String id) throws ApiException {
        ApiResponse<Robot> resp = apiRobotsRobotIdGetWithHttpInfo(id);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Robot> apiRobotsRobotIdGetWithHttpInfo(String id) throws ApiException {
